...
export default {
  ...
  tutorial_step1_description:
    "Start by selecting a country to play in. Each country offers a different challenge - from the Swiss Alps to the French coastline or the German plains. To change your country and start a new game, click on the globe button in the top right corner.",
