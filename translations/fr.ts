...
export default {
  ...
  want_contact: "Je souhaite être contacté(e)",
  ...
  about_content: `
   ...
   `,
    ...
    contact_me_content: `
     <b>
       Chez Camptocamp, nous construisons bien plus que des jeux.
     </b>
     <p>
       Laissez-nous transformer vos données géospatiales en véritable intelligence commerciale.
     </p>
   `,
} as Translation;
